 ...
 * This is the privacy enforcement layer — the Baileys service refuses to
 * process any message from a group not in this list.
 *
 * Limit: max 5 groups per user (enforced here). This also reduces ban risk
 * because the listener only cares about a tiny fraction of all messages.
 */
